  ...
  const faqData = {
    ...
    security: [
      ...
      },
      {
        ...
        answer: "Pronova established institutional insurance frameworks through specialized providers prior to the pre-sale launch:\n\n🛡️ CoverTech Insurance — full cyber-insurance coverage protecting the token, platform, and digital assets; data breaches, cyberattacks, and business-interruption events (covertechinsurance.com)\n\n🔐 Assurax Insurance — cyber insurance; hot wallet security breaches; private key compromise; cyberattack-induced disruptions (assuraxinsurance.com)\n\nThese arrangements are verifiable through official websites. Note: no system can guarantee absolute protection — participants should conduct their own risk assessment."
      },
      {
